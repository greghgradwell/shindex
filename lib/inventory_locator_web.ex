defmodule InventoryLocatorWeb do
  @moduledoc """
  ...
  def static_paths, do: ~w(assets fonts images uploads documents favicon.ico robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: InventoryLocatorWeb.Router,
        statics: InventoryLocatorWeb.static_paths()
    end
  end
